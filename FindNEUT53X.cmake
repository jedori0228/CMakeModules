...
if(NEUT_FOUND)
  ...
  FILE(GLOB NEUT_LIB_LIST ${NEUT_LIB_DIR}/*_5.3*.a)
  ...
  #neut 5.3.X build system doesn't install this one headerfile properly
  ...
  if(EXISTS "${NEUT_ROOT}/src/neutclass/neutnucfsistep.so")
    ...
    LIST(APPEND NEUT_INCLUDE_DIRS ${NEUT_ROOT}/src/neutclass)
  endif()
